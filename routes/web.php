...
Route::get('/front-end-login/', function () {
    return view('auth.front-end-login');
})->name('front-end-login');
...
Route::middleware(['auth', 'role'])->group(function () {
    ...
    Route::get('return-order/index', [ReturnOrderController::class, 'index'])->name('return-order.index');
    Route::get('return-order/show/{id}', [ReturnOrderController::class, 'show'])->name('return-order.show');
    // Route::get('order/create', [OrderController::class, 'create'])->name('order.create');
    // Route::post('order/store', [OrderController::class, 'store'])->name('order.store');
    // Route::get('order/edit/{id}', [OrderController::class, 'edit'])->name('order.edit');
    // Route::get('order/show/{id}', [OrderController::class, 'show'])->name('order.show');
    Route::post('change-return-status', [ReturnOrderController::class, 'changeReturnStatus']);
    // Route::get('fetch-order-status', [OrderController::class, 'fetchOrderStatus']);
});
