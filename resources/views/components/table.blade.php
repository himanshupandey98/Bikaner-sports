                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            ...
                                            style="width: 218.375px;">User</th>
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1"
                                            aria-label="Role: activate to sort column ascending"
                                            style="width: 127.016px;">Role</th>
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1"
                                            aria-label="Last login: activate to sort column ascending"
                                            style="width: 127.016px;">Last login</th>
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1"
                                            aria-label="Two-step: activate to sort column ascending"
                                            style="width: 127.016px;">Two-step</th>
                                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users"
                                            rowspan="1" colspan="1"
                                            aria-label="Joined Date: activate to sort column ascending"
                                            style="width: 169.5px;">Joined Date</th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <!--end::Role=-->
                                        <!--begin::Last login=-->
                                        <td data-order="2023-07-19T12:11:26+05:30">
                                        ...
                                        <!--end::Two step=-->
                                        <!--begin::Joined-->
                                        <td data-order="2022-06-20T22:10:00+05:30">20 Jun 2022, 10:10 pm</td>
                                        <!--begin::Joined-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
