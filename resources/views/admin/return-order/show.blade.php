<x-AdminLayout>
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <form action="{{ url('change-return-status?order_id='.$order->order_id) }}" class="d-flex mb-3" method="POST">
                @csrf
                <label for="" class="form-label mx-3">Return Status :</label>


                <select name="return_status" id="" class="form-select">
                    @foreach (ReturnStatus() as $key => $value)
                        <option value="{{ $key }}" {{ $order->return_status==$key?'selected':'' }}>
                            {{ $value }}
                        </option>
                    @endforeach
                </select>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl mb-3">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">
                                                {{ date('d-M-Y g:i A', strtotime($order->created_at)) }}</td>
                                        </tr>
                                        <!--end::Date-->
                                        ...
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->Payment Id
                                                </div>
                                            </td>
                                            <td class="fw-bold text-end">{{ $order->payment_id }}
                                                <img src="assets/media/svg/card-logos/visa.svg" class="w-50px ms-2">
                                            </td>
                                        </tr>
                                        <!--end::Payment method-->
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @foreach ($order['cart'] as $key => $value)
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="{{ $value->product_image }}" target="_blank"
                                                        ...
                                                        <span class="symbol-label"
                                                            style="background-image:url({{ $value->product_image }});"></span>
                                                    ...
                                                    <div class="ms-5">
                                                        <a href="{{ $value->product_image }}" target="_blank"
                                                            class="fw-bold text-gray-600 text-hover-primary">{{ $value->product_sku }}</a>
                                            ...
                                            <!--end::Quantity-->
                                            <!--begin::Price-->
                                            <td class="text-end">{{ 'Rs.' . $value->product_price . '/-' }}</td>
                                            <!--end::Price-->
                                            <!--begin::Total-->
                                            <td class="text-end">
                                                {{ 'Rs.' . $value->product_qty * $value->product_price . '/-' }}</td>
