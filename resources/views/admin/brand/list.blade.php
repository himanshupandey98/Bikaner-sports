        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Brands
                        List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ url('brand/create') }}" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px sorting" tabindex="0"
                                                aria-controls="kt_table_users" rowspan="1" colspan="1"
                                                aria-label="User: activate to sort column ascending"
                                                style="width: 218.375px;">Brand Name</th>
                                            <th class="min-w-125px sorting" tabindex="0"
                                                aria-controls="kt_table_users" rowspan="1" colspan="1"
                                                aria-label="Role: activate to sort column ascending"
                                                style="width: 127.016px;">Brand Image</th>
                                    ...
                                    <tbody class="text-gray-600 fw-semibold">
                                        @foreach ($brands as $item)
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    <a href="{{ url(Storage::url('brands/' . $item->image)) }}"
                                                        target="_blank">

                                                        <img src="{{ url(Storage::url('brands/' . $item->image)) }}"
                                                            alt="" width="60px">
                                                    </a>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ url('brand/edit/' . Crypt::encrypt($item->id)) }}"
                                                                class="menu-link px-3">Edit</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ url('brand/destroy/' . Crypt::encrypt($item->id)) }}"
