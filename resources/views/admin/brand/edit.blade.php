        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl d-flex justify-content-center">
                ...
                <div class="card w-50 ">
                    ...
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <form action="{{ url('brand/update/'.Crypt::encrypt($brand->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body py-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <img src="{{ url(Storage::url('brands/'.$brand->image)) }}" alt="" width="100px" class="mt-3">
                            </div>
                            <div class="form-group mb-3">
