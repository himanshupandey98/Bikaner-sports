        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl d-flex justify-content-center">
                ...
                <div class="card w-100 p-5">
                    ...
                    <!--end::Card header-->
                    <!--begin::Card body-->
                    <form action="{{ url('product/update/'.Crypt::encrypt($product->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body py-4 row">
                            <div class="col">
                                ...
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-select" data-control="select2" data-placeholder="Select an option" name="brand_id">
                                        <option></option>
                                ...
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-select" data-control="select2" data-placeholder="Select an option" name="sports_category_id">
                                        <option></option>
                                        @foreach ($sports_categories as $key => $value)
                                        <option value="{{ $key }}" {{ $product->sports_category_id==$key?'selected':'' }}>{{ $value }}</option>
                                ...
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-select" data-control="select2" data-placeholder="Select an option" name="category_id">
                                        <option></option>
                            ...
                            <div class="col">
                                ...
                                <textarea type="textarea" name="description" class="form-control" rows="16">
                                    {{ $product->description  }}
                                </textarea>
                            </div>
                            {{-- <div class="col">
