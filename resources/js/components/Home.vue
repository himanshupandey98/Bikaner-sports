    ...
    <main class="main">
        <div class="intro-section bg-lighter pt-5 pb-6">
            <div class="container">
                ...
                <div class="owl-carousel owl-simple" style="display:flex;justify-content:space-evenly" data-toggle="owl" data-owl-options='{
                            "nav": false, 
                            "dots": false,
                            "margin": 30,
                            "loop": false,
                    ...
                    <div v-for="brand in brands" :key="brand.id" height="100px" class="BrandImg" @mouseover="SizeIncrease()" @mouseleave="ResetSize()">
