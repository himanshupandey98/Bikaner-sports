                    ...
                    <ul class="top-menu">
                        <li>
                            ...
                            <ul>
                                ...
                                <li v-if="!loggedUser"><a href="/front-end-login" ><i class="icon-user"></i>Login</a></li>
                                <li v-else><a href="" @click.prevent="logout" ><i class="icon-user"></i>Logout</a></li>
                            </ul>
                        </li>
                    </ul><!-- End .top-menu -->
            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="index.html" class="logo">
                        <div class="h4 text-danger d-inline">
                            Bikaner Sports
                        </div>
                    </a>
                ...
                <div class="header-right">
                    ...
                    <div class="dropdown cart-dropdown">
                        <a href="/show-cart" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                            <i class="icon-shopping-cart"></i>
                            <span class="cart-count">{{cartItemsCount}}</span>
                        </a>

                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-cart-products" v-if="cartItemsCount">
                                <div class="product" v-for="item in cartItems" :key="item.id">
                                    <div class="product-cart-details">
                                        <h4 class="product-title">
                                            <a href="product.html">{{item.product_sku}}</a>
                                        </h4>

                                        <span class="cart-product-info">
                                            <span class="cart-product-qty">{{item.product_qty}}</span>
                                            x {{ 'Rs.'+item.product_price+'/-' }}
                                        </span>
                                    ...
                                    <a href="#" class="btn-remove" title="Remove Product" @click.prevent="deleteCartItem(item.id)"><i class="icon-close"></i></a>
                                </div>

                            </div><!-- End .cart-product -->

                            <div class="dropdown-cart-total" v-if="cartItemsCount">
                                <span>Total</span>
